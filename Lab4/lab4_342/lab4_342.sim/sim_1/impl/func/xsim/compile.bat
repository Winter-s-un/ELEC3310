...
REM
REM Generated by Vivado on Fri Oct 11 23:48:31 +0800 2024
...
echo "xvlog --incr --relax -prj four_bit_adder_sub_tb_342_vlog.prj"
call xvlog  --incr --relax -prj four_bit_adder_sub_tb_342_vlog.prj -log xvlog.log
